...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>@lang('site.order_media')</h1>
        <ol class="breadcrumb">
            <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> @lang('site.dashboard')</a></li>
            <li class="active">@lang('site.order_media')</li>
        </ol>
    </section>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">@lang('site.order_media')</h3>
                    </div>

                    <div class="box-body">
                        @if($orderMedia->count() > 0)
                            <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card">
                                            ...
                                            @if(in_array(pathinfo($media->media_path, PATHINFO_EXTENSION), ['jpg', 'jpeg','JPEG','JPG', 'PNG','png', 'gif']))
                                                <img src="{{ asset($media->media_path) }}" class="img-thumbnail w-100" style="height: 200px; object-fit: cover;" alt="Order Media">
                                            ...
                                            <div class="card-body text-center">
                                                <form method="POST" action="{{ route('dashboard.order.media.delete', $media->id) }}" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
            ...
            <div class="col-md-4">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form action="{{ route('dashboard.order.media.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
